...
public class TeamSupportModel   {
private TeamSupport TeamSupport;
private List<TeamSupport> listTeamSupport= new ArrayList<TeamSupport>();
...
public TeamSupport getTeamSupport() {
	return TeamSupport;
}
public void setTeamSupport(TeamSupport teamSupport) {
	TeamSupport = teamSupport;
}
public List<TeamSupport> getListTeamSupport() {
	return listTeamSupport;
}
public void setListTeamSupport(List<TeamSupport> listTeamSupport) {
	this.listTeamSupport = listTeamSupport;
}
