...
private MatchReminder MatchReminder;
private List<MatchReminder> listMatchReminder= new ArrayList<MatchReminder>();
...
public MatchReminder getMatchReminder() {
	return MatchReminder;
}
public void setMatchReminder(MatchReminder matchReminder) {
	MatchReminder = matchReminder;
}
public List<MatchReminder> getListMatchReminder() {
	return listMatchReminder;
}
public void setListMatchReminder(List<MatchReminder> listMatchReminder) {
	this.listMatchReminder = listMatchReminder;
}
