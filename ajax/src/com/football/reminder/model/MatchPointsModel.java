...
private List<MatchPoints> listMatchPoints= new ArrayList<MatchPoints>();
...
public List<MatchPoints> getListMatchPoints() {
	return listMatchPoints;
}
public void setListMatchPoints(List<MatchPoints> listMatchPoints) {
	this.listMatchPoints = listMatchPoints;
}
